    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          {
            type: 'text',
            text: quiz.multiple_choice.question,
            size: 'sm',
            wrap: true,
            color: '#333333',
          },
          {
            type: 'text',
            text: Object.entries(quiz.multiple_choice.options)
              .map(([k, v]) => `${k}. ${v}`)
              .join('\n'),
            size: 'sm',
            wrap: true,
          ...
          {
            type: 'text',
            text: quiz.make_sentence.question.replace('___', `"${quiz.make_sentence.target_word}"`),
            size: 'sm',
            wrap: true,
            color: '#333333',
          },
...
export async function replyTranslation(replyToken, result) {
  try {
    ...
    if (result.type === 'word') {
      contents = {
        ...
        header: {
          ...
          paddingAll: '16px',
          contents: [
            { type: 'text', text: '🔤 單字翻譯', color: '#A8D8EA', size: 'xs', weight: 'bold' },
            { type: 'text', text: result.english, color: '#FFFFFF', size: 'xxl', weight: 'bold' },
            { type: 'text', text: result.pronunciation || '', color: '#A8D8EA', size: 'sm' },
            { type: 'text', text: result.chinese + '　' + result.definition_zh, color: '#CCCCFF', size: 'sm', wrap: true },
          ],
        },
        body: {
          type: 'box',
          ...
          contents: [
            ...
            { type: 'separator' },
            {
              ...
              contents: [
                { type: 'text', text: '🔗 相似詞', size: 'sm', weight: 'bold', color: '#0F6E56' },
                { type: 'text', text: (result.synonyms || []).join('　'), size: 'sm', color: '#333333', wrap: true },
              ],
            },
            {
              type: 'box', layout: 'vertical', spacing: 'xs',
              contents: [
                { type: 'text', text: '↔️ 相反詞', size: 'sm', weight: 'bold', color: '#D85A30' },
                { type: 'text', text: (result.antonyms || []).join('　'), size: 'sm', color: '#333333', wrap: true },
              ],
            },
            {
              type: 'box', layout: 'vertical', spacing: 'xs',
              contents: [
                { type: 'text', text: '📌 常見搭配', size: 'sm', weight: 'bold', color: '#534AB7' },
                { type: 'text', text: (result.collocations || []).join('、'), size: 'sm', color: '#333333', wrap: true },
              ],
            },
          ],
        },
      ...
      contents = {
        ...
        header: {
          ...
          paddingAll: '16px',
          contents: [
            { type: 'text', text: '🌐 道地英文翻譯', color: '#A8D8EA', size: 'xs', weight: 'bold' },
            { type: 'text', text: result.chinese, color: '#CCCCFF', size: 'sm', wrap: true },
          ],
        },
        body: {
          type: 'box',
          ...
          contents: [
            {
              type: 'text', text: result.english,
              size: 'lg', weight: 'bold', color: '#1A1A2E', wrap: true,
            },
            { type: 'separator' },
            {
              type: 'box', layout: 'vertical', spacing: 'xs',
              contents: [
                { type: 'text', text: '💡 為什麼這樣翻？', size: 'sm', weight: 'bold', color: '#534AB7' },
                { type: 'text', text: result.explanation || '', size: 'sm', color: '#555555', wrap: true },
              ],
            },
            {
              type: 'box', layout: 'vertical', spacing: 'xs',
              contents: [
                { type: 'text', text: '🔄 其他說法', size: 'sm', weight: 'bold', color: '#0F6E56' },
                ...(result.alternatives || []).map(a => ({
                  type: 'text', text: `• ${a}`, size: 'sm', color: '#333333', wrap: true,
                })),
              ],
            },
            {
              type: 'box', layout: 'vertical', spacing: 'xs',
              contents: [
                { type: 'text', text: '📝 直譯（供對比）', size: 'xs', weight: 'bold', color: '#999999' },
                { type: 'text', text: result.literal || '', size: 'xs', color: '#AAAAAA', wrap: true },
              ],
            },
          ],
        },
    ...
    await client.replyMessage({
      replyToken,
      messages: [{ type: 'flex', altText: `翻譯：${result.english}`, contents }],
    });
